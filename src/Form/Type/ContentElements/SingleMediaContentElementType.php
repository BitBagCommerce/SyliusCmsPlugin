...
final class SingleMediaContentElementType extends AbstractType
{
    ...
    public function __construct(private DataTransformerInterface $singleMediaToCodeTransformer)
    {
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->get(self::TYPE)->addModelTransformer($this->singleMediaToCodeTransformer);
    }
